...
var deleteOneObs = function (ObservationIDToDelete) { return __awaiter(void 0, void 0, void 0, function () {
    var tableName, command, response, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                error_1 = _a.sent();
                console.error("Error deleting item:", error_1);
                throw error_1; // Rethrow the error to indicate failure
            case 4: return [2 /*return*/];
        }
    });
}); };
exports.deleteOneObs = deleteOneObs;
